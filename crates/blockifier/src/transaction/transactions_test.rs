...
use crate::test_utils::{
    ...
    CURRENT_BLOCK_TIMESTAMP, CURRENT_BLOCK_TIMESTAMP_FOR_VALIDATE, CairoVersion, MAX_FEE,
    MAX_L1_GAS_AMOUNT, MAX_L1_GAS_PRICE, NonceManager, SaltManager, TEST_SEQUENCER_ADDRESS,
...
use crate::transaction::test_utils::{
    ...
    l1_resource_bounds, max_resource_bounds,
};
...
fn test_invoke_tx_advanced_operations(
    ...
    let expected_msg = OrderedL2ToL1Message {
        order: 0,
        message: MessageToL1 {
            to_address: ContractAddress::try_from(to_address).unwrap(),
